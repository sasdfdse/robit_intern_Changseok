...
public :
 ...
 rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface::CallbackReturn on_activate(const rclcpp_lifecycle::State &state); //unconfigure 상태에서 inactive 상태로 변환 

 rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface::CallbackReturn on_deactivate(const rclcpp_lifecycle::State &state); //unconfigure 상태에서 inactive 상태로 변환 

 rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface::CallbackReturn on_cleanup(const rclcpp_lifecycle::State &state); //unconfigure 상태에서 inactive 상태로 변환 

 rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface::CallbackReturn on_shutdown(const rclcpp_lifecycle::State &state); //unconfigure 상태에서 inactive 상태로 변환 
